 ...
 */
      ...
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      if (unlikely(PyObject_SetItem(__pyx_v_W, __pyx_tuple__3, __pyx_t_3) < 0)) __PYX_ERR(0, 15, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
            ...
            if ((1 == 0)) abort();
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp parallel private(__pyx_t_11, __pyx_t_12, __pyx_t_13, __pyx_t_14, __pyx_t_15, __pyx_t_16, __pyx_t_17, __pyx_t_18, __pyx_t_19) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                    #endif /* _OPENMP */
                    {
                        #ifdef _OPENMP
                        #ifdef WITH_THREAD
 ...
 */
                                  ...
                                  __pyx_t_16 = -1;
                                  if (__pyx_t_15 < 0) {
                                    __pyx_t_15 += __pyx_v_vW.shape[0];
                                    if (unlikely(__pyx_t_15 < 0)) __pyx_t_16 = 0;
                                  } else if (unlikely(__pyx_t_15 >= __pyx_v_vW.shape[0])) __pyx_t_16 = 0;
                                  if (__pyx_t_14 < 0) {
                                    __pyx_t_14 += __pyx_v_vW.shape[1];
                                    if (unlikely(__pyx_t_14 < 0)) __pyx_t_16 = 1;
                                  } else if (unlikely(__pyx_t_14 >= __pyx_v_vW.shape[1])) __pyx_t_16 = 1;
                                  if (unlikely(__pyx_t_16 != -1)) {
                                    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_16);
                                    __PYX_ERR(0, 19, __pyx_L10_error)
                                  }
                                  *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_vW.data + __pyx_t_15 * __pyx_v_vW.strides[0]) ) + __pyx_t_14 * __pyx_v_vW.strides[1]) )) = (__pyx_t_17 / __pyx_t_19);
 ...
 */
                                  ...
                                  __pyx_t_17 = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_vW.data + __pyx_t_14 * __pyx_v_vW.strides[0]) ) + __pyx_t_15 * __pyx_v_vW.strides[1]) ))) * (3 + (2 * __pyx_v_j))) * (__pyx_v_n - (2 * __pyx_v_b)));
                                  if (unlikely(__pyx_v_j == 0)) {
                                    #ifdef WITH_THREAD
                                    PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
                                    #endif
                                  ...
                                  *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_vW.data + __pyx_t_15 * __pyx_v_vW.strides[0]) ) + __pyx_t_14 * __pyx_v_vW.strides[1]) )) += (__pyx_t_18 / __pyx_t_19);
                                }
                                goto __pyx_L15;
                                __pyx_L10_error:;
                                {
 ...
 *     assert n >= 1
 */
  __pyx_tuple__21 = PyTuple_Pack(1, Py_None); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 5, __pyx_L1_error)
 ...
 *     W = np.zeros([n - 1, n - 1], dtype=float)
 */
  __pyx_tuple__22 = PyTuple_Pack(7, __pyx_n_s_n, __pyx_n_s_n, __pyx_n_s_W, __pyx_n_s_vW, __pyx_n_s_b, __pyx_n_s_j, __pyx_n_s_bb); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(1, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_momi_w_matrix_pyx, __pyx_n_s_Wmatrix, 6, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 6, __pyx_L1_error)
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_w_matrix(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'w_matrix' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
 ...
 *     assert n >= 1
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_lru_cache); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_tuple__21, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init momi.w_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
