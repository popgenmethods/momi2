...
:RESULTS:
# Out[6]:
[[file:./obipy-resources/28149L1U.png]]
:END:
...
# Out[13]:
#+BEGIN_EXAMPLE
  fun: 0.0012547237060575788
  jac: array([ 9.03212290e-06, -8.42589141e-02, -1.08052715e-09])
  message: 'Converged (|f_n-f_(n-1)| ~= 0)'
  nfev: 69
  nit: 29
  parameters: ParamsDict({'n_chb': 3072604.5739751398, 'g_chb': 0.000820449228606471, 't_chb_yri': 113434.99838588433})
  status: 1
  success: True
  x: array([1.49380362e+01, 8.20449229e-04, 1.03434998e+05])
#+END_EXAMPLE
:END:
...
# Out[14]:
#+BEGIN_EXAMPLE
  ParamsDict([('n_chb', 3072604.5739751398),
  ('g_chb', 0.000820449228606471),
  ('t_chb_yri', 113434.99838588433)])
#+END_EXAMPLE
:END:
...
:RESULTS:
# Out[15]:
[[file:./obipy-resources/28149Y_a.png]]
:END:
...
# Out[17]:
#+BEGIN_EXAMPLE
  fun: 0.012623828568856266
  jac: array([-4.43860912e-07,  9.76573115e-02,  1.22353558e-10,  2.46188266e-12])
  message: 'Converged (|f_n-f_(n-1)| ~= 0)'
  nfev: 33
  nit: 9
  parameters: ParamsDict({'n_chb': 2899418.220451948, 'g_chb': 0.0008194843052998753, 't_chb_yri': 105037.70430361234, 't_anc': 441680.28546608094})
  status: 1
  success: True
  x: array([1.48800207e+01, 8.19484305e-04, 9.50377043e+04, 3.36642581e+05])
#+END_EXAMPLE
:END:
...
:RESULTS:
# Out[18]:
[[file:./obipy-resources/28149lJh.png]]
:END:
...
#+RESULTS:
:RESULTS:
JackknifeGoodnessFitStat(expected=0.0, observed=-0.005661024702653249, sd=0.0028238767826156788, z_score=-2.00469961632306)
:END:
...
# Out[25]:
#+BEGIN_EXAMPLE
  fun: 2.916255748059337
  jac: array([-3.26423624e-03,  3.12638570e+01,  1.46177705e-07, -4.13073751e-08,
  -7.55870211e-03,  1.12631411e-02, -2.52477666e-06])
  message: 'Maximum number of iterations reached'
  nit: 9
  success: False
  x: array([ 1.43433942e+01,  1.00000000e-03,  9.50384783e+04,  3.36642719e+05,
  -2.47835805e+00, -2.03682648e+00,  6.34744929e-01])
#+END_EXAMPLE
:END:
...
# Out[26]:
#+BEGIN_EXAMPLE
  fun: 0.004325475626152443
  jac: array([ 6.10685927e-06, -1.02133901e-01,  2.25007307e-10,  3.15581959e-10,
  1.36069411e-05,  1.90121964e-06,  2.94538017e-07])
  message: 'Max. number of function evaluations reached'
  nfev: 100
  nit: 21
  parameters: ParamsDict({'n_chb': 11203513.170782406, 'g_chb': 0.001, 't_chb_yri': 88327.17968883236, 't_anc': 469270.5044609507, 'p_pulse': 0.06782051950763485, 't_pulse': 37195.28743307708, 't_ghost': 50121.932072287906})
  status: 3
  success: False
  x: array([ 1.62317380e+01,  1.00000000e-03,  7.83271797e+04,  3.80943325e+05,
  -2.62066058e+00, -3.18226346e-01, -8.14251662e+00])
#+END_EXAMPLE
:END:
...
:RESULTS:
# Out[27]:
[[file:./obipy-resources/28149yTn.png]]
:END:
